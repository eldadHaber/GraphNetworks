...
if __name__ == '__main__':
    ...
    for epoch in range(epochs):
        ...
        t2 = time.time()
        aloss_v,aloss_E_v,aloss_F_v,MAE_v,Fps_v,Fts_v,t_dataload_v, t_prepare_v, t_model_v, t_backprop_v = use_model(model, dataloader_val, train=False, max_samples=1, optimizer=optimizer, device=device, batch_size=batch_size, use_mean_map=use_mean_map, channels=nopen*3,R_mean=R_mean)
        t3 = time.time()
